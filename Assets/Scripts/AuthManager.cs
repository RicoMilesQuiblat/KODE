...
public class AuthManager : MonoBehaviour
{
    ...
    {
        //(string _name, string _age, string _email, string _password)
    ...
    private IEnumerator Register(string _name, string _age, string _email, string _password)
    {
        if (_name == "" || _age == "" || _email == "" || _password == "")
        {
            //If the username field is blank show a warning
            warningRegisterText.text = "Invalid Input";
        }
